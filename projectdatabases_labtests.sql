...
CREATE TABLE `labtests` (
  ...
  PRIMARY KEY (`LabId`),
  KEY `LabPFK_idx` (`PRegID`),
  CONSTRAINT `LabPFK` FOREIGN KEY (`PRegID`) REFERENCES `patients` (`PRegNumber`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2023-10-09 23:45:23
/*ggg*/